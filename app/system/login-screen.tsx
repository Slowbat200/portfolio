...
export default function LoginScreen() {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-zinc-950">
            ...
            <Card className="w-full max-w-sm bg-zinc-900/50 border-zinc-800 backdrop-blur-md">
                <CardHeader className="flex flex-col items-center gap-4 pt-8">
                    ...
                    <div className="text-center space-y-1">
                        <CardTitle className="text-2xl font-bold text-zinc-100">Guest</CardTitle>
            ...
            <div className="absolute bottom-6 text-zinc-500 text-xs font-mono">
